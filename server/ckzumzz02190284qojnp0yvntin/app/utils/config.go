...
func SetDefaults() {
	...
	viper.SetDefault("RECORDING_MODE", "mix")

	if viper.GetString("RECORDING_MODE") != "mix" && viper.GetString("RECORDING_MODE") != "individual" {
		log.Fatal("RECORDING_MODE should be mix or individual")
	}
